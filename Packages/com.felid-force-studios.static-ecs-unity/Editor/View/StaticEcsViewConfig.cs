...
namespace FFS.Libraries.StaticEcs.Unity.Editor
{
    ...
    {
        const string EditorPrefsKey = "StaticEcsView_ConfigGUID";
        const string DefaultPath = "Assets/Editor/StaticEcsViewConfig.asset";

        static StaticEcsViewConfig _cached;
        ...
        internal WorldViewSettings GetOrCreate(string worldTypeFullName)
        {
            foreach (var w in worlds)
                if (w.worldTypeFullName == worldTypeFullName)
                    return w;
        ...
        static StaticEcsViewConfig CreateDefault()
        {
