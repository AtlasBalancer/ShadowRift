...
namespace FFS.Libraries.StaticEcs.Unity
{
    ...
    {
        void OnControllerColliderHit(ControllerColliderHit data)
        {
            if (!CanSend()) return;
    ...
    public abstract class
        ControllerColliderHit3DEntityGIDProvider<TWorld> : ControllerColliderHit3DEntityProvider<TWorld>
        where TWorld : struct, IWorldType
    {
...
#endif
    public abstract class
        ControllerColliderHit3DEntityRefProvider<TWorld, TProvider> : ControllerColliderHit3DEntityProvider<TWorld>
        where TWorld : struct, IWorldType
