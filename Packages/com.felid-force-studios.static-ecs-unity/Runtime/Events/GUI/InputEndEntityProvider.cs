...
namespace FFS.Libraries.StaticEcs.Unity
{
    ...
    public abstract class InputEndEntityProvider<TWorld> : GUIEntityEventProvider<TWorld>
        where TWorld : struct, IWorldType
    {
        ...
        {
            World<TWorld>.SendEvent(new InputEndEntityEvent
            {
                Ref = input,
                EntityGID = EntityGID,
                Value = value
    ...
    [Il2CppSetOption(Option.ArrayBoundsChecks, Const.IL2CPPArrayBoundsChecks)]
#endif
    public abstract class InputEndEntityGIDProvider<TWorld> : InputEndEntityProvider<TWorld>
        where TWorld : struct, IWorldType
    {
    ...
    [Il2CppSetOption(Option.ArrayBoundsChecks, Const.IL2CPPArrayBoundsChecks)]
#endif
    public abstract class InputEndEntityRefProvider<TWorld, TProvider> : InputEndEntityProvider<TWorld>
        where TWorld : struct, IWorldType
