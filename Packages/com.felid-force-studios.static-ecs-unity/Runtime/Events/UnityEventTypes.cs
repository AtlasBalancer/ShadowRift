    ...
    public static class UnityEventTypes
    {
        public static void Register<TWorld>() where TWorld : struct, IWorldType
        {
            World<TWorld>.Types()
                ...
                .Tag<PointerHoverState>()
                .Tag<PointerPressedState>()
                .Component<DragState>()
                ...
                .Event<SubmitEvent>()
                .Event<SubmitEntityEvent>()
                .Event<CancelEvent>()
                .Event<CancelEntityEvent>()
                .Event<ButtonClickEvent>()
                .Event<ButtonClickEntityEvent>();
            ...
            World<TWorld>.Types()
                .Event<AnimationEventEcsEvent>()
                .Event<AnimationEventEntityEcsEvent>()
                .Event<AnimatorStateEnterEvent>()
                .Event<AnimatorStateExitEvent>()
                .Event<AnimatorStateEnterEntityEvent>()
                .Event<AnimatorStateExitEntityEvent>();
#endif
        }
    }
}