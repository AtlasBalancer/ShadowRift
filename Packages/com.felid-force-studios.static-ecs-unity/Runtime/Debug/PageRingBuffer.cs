...
namespace FFS.Libraries.StaticEcs.Unity
{
    ...
    public struct PageView<T> where T : IEquatable<T>
    {
        ...
        public PageViewEnumerator<T> GetEnumerator()
        {
            return new PageViewEnumerator<T>(this);
        }
    ...
    public ref struct PageViewEnumerator<T> where T : IEquatable<T>
    {
        ...
        public ref T Current => ref View[Count];
    ...
    public sealed class PageRingBuffer<T> where T : IEquatable<T>
    {
        ...
        public PageRingBuffer(int pageCount, int pageSize = 16)
        {
            ...
            for (var i = 0; i < Pages.Length; i++) Pages[i] = new Page(i);
        ...
        public void Reset()
        {
            for (var i = 0; i < Pages.Length; i++) Pages[i].Reset(i);
